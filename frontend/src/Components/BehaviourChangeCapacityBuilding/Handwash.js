...
export default function Handwash() {
  ...
  //           response?.data?.message?.use_school_premises === null
  //             ? "Single School - Single shift"
  //             : response?.data?.message?.use_school_premises
  //         );
  //         setValue(
  ...
  //           response?.data?.message?.school_location
  //         );
  //         setValue("Longitude", response?.data?.message?.longitude);
  //         setValue("Latitude", response?.data?.message?.latitude);
  //         setValue("name_respondent17", userinfos?.respondant_name);
  //         setValue("designation_respondent18", userinfos?.designation);
  //         setValue("contact_respondent_mobile", userinfos?.mobile);
